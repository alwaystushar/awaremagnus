 ...
 * ================================================
 * Calendar input with 47px height to match input fields
 */
...
class ModernCalendar {
  ...
  addStyles() {
    ...
    style.textContent = `
      ...
      /* Calendar Input - 47px height to match input-field */
      .modern-calendar {
        width: 100%;
        height: 47px;
      ...
      /* Error State */
      .modern-calendar.error {
        border-color: #ef4444;
      }

      .modern-calendar.error:focus {
        box-shadow: 0 0 0 3px rgba(239, 68, 68, 0.1);
      }

      /* Success State */
      .modern-calendar.success {
        border-color: #10b981;
      }

      .modern-calendar.success:focus {
